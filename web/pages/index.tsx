...
export default function Home() {
  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '50px', fontFamily: 'sans-serif' }}>
      <h1>📝 SecFolio Builder</h1>
      <p>Create your public resume and apply for the Security position.</p>
      ...
      <div style={{ padding: '25px', backgroundColor: '#f8f9fa', border: '1px solid #ddd', borderRadius: '8px' }}>
        ...
        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div>
            ...
            <input type="text" required value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Hong Gildong" style={{ width: '100%', padding: '10px', borderRadius: '4px', border: '1px solid #ccc' }} />
          </div>
          <div>
            <label style={{ fontWeight: 'bold', display: 'block', marginBottom: '5px' }}>Job Title:</label>
            <input type="text" required value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Security Engineer" style={{ width: '100%', padding: '10px', borderRadius: '4px', border: '1px solid #ccc' }} />
          </div>
